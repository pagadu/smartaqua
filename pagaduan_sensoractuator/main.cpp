...
#include "modules/SensorActuator/SensorActuatorModule.h"

SensorActuatorModule sensorActuator;
void setupSensorActuatorModule()
{
    // Initialize all modules here
    sensorActuator.setup();
}

void loopSensorActuatorModule()
{
    // Initialize all modules here
    sensorActuator.loop();
}
void handleIncomingPacket(meshtastic_MeshPacket *p) {
    Serial.println("[MAIN] handleIncomingPacket: ");
    sensorActuator.handleIncomingPacket(p);
}
